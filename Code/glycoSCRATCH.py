...
# TODO 
# 1. Make the sugar monomers a bit smaller and custom edit them in Inkscape.
#    Specifically, make all the sugar buttons about 2/3 as tall (make them shorter)
#    so that they don't take up as much vertical space.
# 2. Make the canvas area larger and the actual structure smaller
# 3. Edit the code so it's super streamlined to add new sugar types. 
#    This should be as easy as simply adding a new item to sugar_dict which
#    displays in the correct location.
# 4. Low priority: edit colors

# Dict of sugar monomers in the correct display order
sugar_dict = {
    "Glc": {"color":"Blue", "shape":"circle", "display_row":"PLACEHOLDER"},
    # Add new sugar types below ...
...
class GridApplication:
    def __init__(self, master):
        ...
        column_0.pack(side="left", padx=10, pady=10, anchor="n")
    ...
    # Sugar buttons ______________________________________________________________
        ...
        tk.Label(button_r0_c0, text="Sugar Menu", font=("Arial", 10, "bold"), bg='lightgray').pack(side="left", padx=5)
    ...
    # Linkage buttons ____________________________________________________________
        ...
        tk.Label(button_r2_0_c0, text="Linkage Menu", font=("Arial", 10, "bold"), bg='lightgray').pack()
        ...
        linkage_button_size = (33,24)

        # Category 1 -----------------------------------------------------------
        self.a1to2_img = Image.open(resource_path("Assets/Button_imgs/α1,2.png")).resize(linkage_button_size)
        ...
        self.a1to3_img = Image.open(resource_path("Assets/Button_imgs/α1,3.png")).resize(linkage_button_size)
        ...
        self.a1to4_img = Image.open(resource_path("Assets/Button_imgs/α1,4.png")).resize(linkage_button_size)
        ...
        self.a1to5_img = Image.open(resource_path("Assets/Button_imgs/α1,5.png")).resize(linkage_button_size)
        ...
        self.a1to6_img = Image.open(resource_path("Assets/Button_imgs/α1,6.png")).resize(linkage_button_size)
        ...
        self.a1to7_img = Image.open(resource_path("Assets/Button_imgs/α1,7.png")).resize(linkage_button_size)
        ...
        self.a1to9_img = Image.open(resource_path("Assets/Button_imgs/α1,9.png")).resize(linkage_button_size)
        ...
        # Category 2 -----------------------------------------------------------
        # ADD a2-3
        self.a2to3_img = Image.open(resource_path("Assets/Button_imgs/α2,3.png")).resize(linkage_button_size)
        ...
        # ADD a2-5
        self.a2to5_img = Image.open(resource_path("Assets/Button_imgs/α2,5.png")).resize(linkage_button_size)
        ...
        #
        # ADD a2-6
        self.a2to6_img = Image.open(resource_path("Assets/Button_imgs/α2,6.png")).resize(linkage_button_size)
        ...
        #
        # ADD a2-7
        self.a2to7_img = Image.open(resource_path("Assets/Button_imgs/α2,7.png")).resize(linkage_button_size)
        ...
        #
        # ADD a2-8
        self.a2to8_img = Image.open(resource_path("Assets/Button_imgs/α2,8.png")).resize(linkage_button_size)
        ...
        # Category 3 -----------------------------------------------------------
        self.b1to2_img = Image.open(resource_path("Assets/Button_imgs/ß1,2.png")).resize(linkage_button_size)
        ...
        self.b1to3_img = Image.open(resource_path("Assets/Button_imgs/ß1,3.png")).resize(linkage_button_size)
        ...
        self.b1to4_img = Image.open(resource_path("Assets/Button_imgs/ß1,4.png")).resize(linkage_button_size)
        ...
        self.b1to5_img = Image.open(resource_path("Assets/Button_imgs/ß1,5.png")).resize(linkage_button_size)
        ...
        self.b1to6_img = Image.open(resource_path("Assets/Button_imgs/ß1,6.png")).resize(linkage_button_size)
        ...
        self.b1to7_img = Image.open(resource_path("Assets/Button_imgs/ß1,7.png")).resize(linkage_button_size)
        ...
        self.b1to8_img = Image.open(resource_path("Assets/Button_imgs/ß1,8.png")).resize(linkage_button_size)
        ...
        # self.add_b1to8_button.pack(side="left", padx=5)
        #
        self.b1to9_img = Image.open(resource_path("Assets/Button_imgs/ß1,9.png")).resize(linkage_button_size)
    ...
    # Analysis buttons ___________________________________________________________
        ...
        tk.Label(button_r3_1_c0, text="Analysis Tools", font=("Arial", 10, "bold"), bg='lightgray').pack()

        button_r3_c0 = tk.Frame(column_0)
        button_r3_c0.pack(pady=1, anchor="w")

        # Calculate DCI
        analysis_button_size = (70, 35)

        self.dci_img = Image.open(resource_path("Assets/Button_imgs/dci_img.png")).resize(analysis_button_size)
        ...
        self.pci_img = Image.open(resource_path("Assets/Button_imgs/pci_img.png")).resize(analysis_button_size)
        ...
        # Export image
        self.export_img = Image.open(resource_path("Assets/Button_imgs/exportImage.png")).resize(analysis_button_size)
        ...
        self.reset_img = Image.open(resource_path("Assets/Button_imgs/reset.png")).resize((35, 35))
   ...
   # Canvas _____________________________________________________________________
    ...
    # Instructions and Log ________________________________________________________
        ...
        tk.Label(button_r3_c0, text="Instructions and Log", font=("Arial", 10, "bold"), bg='lightgray').pack(side="left", padx=5)

        # Create a Text widget for printing output
        self.text_area = tk.Text(button_r3_c0, height=3, width=200)
    ...
    def draw_grid(self):
        ...
        for i in range(0, 1800, self.grid_size):
            ...
            self.canvas.create_oval(
                circle_spacing - start_radius, 240 - start_radius, circle_spacing + start_radius, 240 + start_radius,
                fill="black", outline="", tags="grid_dot"
            )

            self.canvas.create_text(
                circle_spacing, 240, text="START", fill="white")
